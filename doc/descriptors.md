# Support for Output Descriptors in ProjectExcelsior Core

Since ProjectExcelsior Core v0.17, there is support for Output Descriptors. This is a
...
existing ProjectExcelsior Core wallets, a convenience function `combo` is
