# Fuzzing ProjectExcelsior Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing ProjectExcelsior Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
[`process_message`](https://github.com/projectexcelsior-project/projectexcelsior/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/projectexcelsior-project/projectexcelsior/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/projectexcelsior-project/projectexcelsior/tree/master/src/test/fuzz).
...
Every single pull request submitted against the ProjectExcelsior Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make ProjectExcelsior Core more robust.
...
with certain assembly code from ProjectExcelsior Core's code. See [developer notes on sanitizers](https://github.com/projectexcelsior-project/projectexcelsior/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing ProjectExcelsior Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing ProjectExcelsior Core using [`afl-fuzz`](https://github.com/google/afl):
