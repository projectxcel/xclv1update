...
"""Verify that starting projectexcelsior with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start projectexcelsior with -h for help text")
        ...
        self.log.info("Start projectexcelsior with -version for version information")
        ...
        self.log.info("Start projectexcelsiord with -fakearg to make sure it does not start")
