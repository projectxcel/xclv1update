// Copyright(C) 2011 - 2020 The ProjectExcelsior Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PROJECTEXCELSIOR_MWEB_MODELS_H
#define PROJECTEXCELSIOR_MWEB_MODELS_H
...
#endif // PROJECTEXCELSIOR_MWEB_MODELS_H