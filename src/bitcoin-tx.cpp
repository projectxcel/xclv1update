...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " projectexcelsior-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  projectexcelsior-tx [options] <hex-tx> [commands]  Update hex-encoded projectexcelsior transaction\n" +
            "or:     projectexcelsior-tx [options] -create [commands]   Create hex-encoded projectexcelsior transaction\n" +
            "\n";
