...
void BitcoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed ProjectExcelsior Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from clipboard..."), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed ProjectExcelsior Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a projectexcelsior: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ProjectExcelsior command-line options").arg(PACKAGE_NAME));
