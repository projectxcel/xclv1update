...
Before you start contributing, familiarize yourself with the ProjectExcelsior Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/projectexcelsior-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to projectexcelsior-qt
...
The following applies to code changes to the ProjectExcelsior Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ProjectExcelsior
